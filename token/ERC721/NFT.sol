...
contract HarmonyProject is ERC721Enumerable, Ownable {
    using Strings for uint256;
    using SafeMath for uint256;

    mapping (uint256 => string) private revealURI;
    string public unrevealURI = "https://api.nfttest.com/meta/";
    ...
    constructor() ERC721("The Harmony Test", "HART") {
        _baseURIextended = "https://api.nfttest.com/meta/";
    ...
    function claimNFTForOwner(uint256 _amount) public onlyOwner {
        uint256 numberOfNfts = _amount;
        require(tokenMinted.add(numberOfNfts) <= MAX_NFT_SUPPLY, "Exceeds max nft supply");
