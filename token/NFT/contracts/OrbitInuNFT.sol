...
// File contracts/OrbitInu.sol

// comment

pragma solidity 0.8.0;

contract OrbitInuNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://ipfs.io/ipfs/QmRb1p6i6DUa257FA7nUEv67WUnQXggVUafyBtvRF9MigP/Balance.mp4";
    bool public reveal = false;

    bool public endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 150000000000000000;
    ...
    mapping (uint256 => uint256) public multiplyLayer;

    mapping (address => bool) public mintHistory;

    address public mainToken;

    constructor(address _mainToken) ERC721("OrbitInuNFT", "OIM81NFT") {
    ...
    function setMainTokenAddr(address _mainToken) public onlyOwner {
        mainToken = _mainToken;
    }
    ...
    function mintNFT(uint256 _MultiVal) public payable {
        require(!pauseMint, "Paused!");
        require(tokenMinted < MAX_NFT_SUPPLY, "Sale has already ended");
        require(getNFTPrice() == msg.value, "ETH value sent is not correct");
        require(mintHistory[msg.sender] == false, "Already minted");
        ...
        _tokenIdentifiers.increment();
        _safeMint(msg.sender, _tokenIdentifiers.current());
        mintHistory[msg.sender] = true;
        multiplyLayer[_tokenIdentifiers.current()] = _MultiVal;
        tokenMinted += 1;
    }


    function mintNFTWithToken(uint256 amount, uint256 _MultiVal) external {
    ...
    function getMultiplyById(uint256 _id) public view returns (uint256) {
        return multiplyLayer[_id];
    }
}
